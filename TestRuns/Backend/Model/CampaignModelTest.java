...
public class CampaignModelTest extends TestCase {
    ...
    public void testGetAllImpressionsByInterval() {
        try {
            CampaignModel cm = new CampaignModel("CocaCola",new File(path + "TestRuns/Backend/Model/TestSamples/click_log.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/impression_log.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/server_log.csv"));
    ...
    public void testGetImpressionsByIntervalSingleDate() {
        try {
            CampaignModel cm = new CampaignModel("Sprite",new File(path + "TestRuns/Backend/Model/TestSamples/click_log.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/impression_log.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/server_log.csv"));
            SimpleDateFormat dateFormat =new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            Date start = dateFormat.parse("2015-01-01 12:00:00");
            Date end = dateFormat.parse("2015-01-01 13:00:00");
    ...
    public void testGetClicksByIntervalSingleDate() {
        try {
            CampaignModel cm = new CampaignModel("Fanta",new File(path + "TestRuns/Backend/Model/TestSamples/click_log.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/impression_log.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/server_log.csv"));
            SimpleDateFormat dateFormat =new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            Date start = dateFormat.parse("2015-01-13 08:57:00");
            Date end = dateFormat.parse("2015-01-13 09:00:00");
    ...
    public void testGetConversionsByIntervalMultipleValuesOnADate() {
        try {
            CampaignModel cm = new CampaignModel("Fanta",new File(path + "TestRuns/Backend/Model/TestSamples/click_log.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/impression_log.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/server_log2.csv"));
            SimpleDateFormat dateFormat =new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            Date start = dateFormat.parse("2015-01-01 12:00:00");
            Date end = dateFormat.parse("2015-01-01 14:00:00");
            Date specific = dateFormat.parse("2015-01-01 12:04:13");
...
//------------------------------------------------------
    public void testGetCTRByInterval() {
        try{
            CampaignModel cm = new CampaignModel("Fanta",new File(path + "TestRuns/Backend/Model/TestSamples/click_logMetrics.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/impression_logMetrics.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/server_logMetrics.csv"));
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            Date start = dateFormat.parse("2015-01-01 12:01:21");
            Date end = dateFormat.parse("2015-01-01 12:30:00");
    ...
    public void testGetOverallBounceRateByInterval() {
        try{
            CampaignModel cm = new CampaignModel("Fanta",new File(path + "TestRuns/Backend/Model/TestSamples/click_logMetrics.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/impression_log.csv"),new File(path+"TestRuns/Backend/Model/TestSamples/server_log.csv"));
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
            Date start = dateFormat.parse("2015-01-01 12:01:21");
            Date end = dateFormat.parse("2015-01-01 12:30:00");
